import 'dart:math';
import 'package:rabbit_run/game/rabbit_run.dart';
import 'package:flame/components.dart';
import '../models/enemy_data.dart';
import 'enemy.dart';

class EnemyManager extends Component with HasGameReference<RabbitRun> {
  ...
  void spawnRandomEnemy() {
    ...
    final List<EnemyData> currentStageEnemies =
        game.currentlevel == 1 ? _stage1Enemies : _stage2Enemies;
...
// Method to spawn stage 1 enemies
  ...
  void initEnemiesForStages() {
    ...
    _stage2Enemies.addAll([
      EnemyData(
        image: game.images.fromCache('Bee/Attack (36x34).png'),
        nFrames: 8,
        stepTime: 0.1,
      ...
      EnemyData(
        image: game.images.fromCache('Rocks/Rock1_Run (38x34).png'),
        nFrames: 14,
        stepTime: 0.1,
